...
public class ArcadeDriftSkidSound extends AutomobileSoundInstance {
    private final SteeringDebugAccessor accessor;

    public ArcadeDriftSkidSound(AutomobileEntity automobile) {
    ...
    protected boolean canPlay(AutomobileEntity automobile) {
        return accessor.momentum$isArcadeDriftActive();
    }
